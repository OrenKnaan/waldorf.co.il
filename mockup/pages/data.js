...
window.WALDORF_DATA = {
  ...
  /* הודעות — לוח פתוח: כל אדם רשאי להגיש הודעה, והיא מתפרסמת רק לאחר אישור מנהל.
     הפריטים שלהלן נסרקו מהאתר הישן (מאמרים + מודעות ופרסומים) ולכן מסומנים כמאושרים. */
  news: [
    { id: 'nw1', status: 'approved', date: '2026-07-22', section: 'מאמרים', title: 'איך נולדת תקופה?',
      summary: 'הצצה אל מאחורי הקלעים של עבודת מחנך ולדורף בבניית תקופת לימוד.', link: '' },
    { id: 'nw2', status: 'approved', date: '2026-07-20', section: 'מודעות ופרסומים', title: 'אסופת קישורים בנושא החופש הגדול',
      summary: 'כלים ורעיונות למשפחות לקראת חופשת הקיץ.', link: '' },
    { id: 'nw3', status: 'approved', date: '2026-07-20', section: 'מודעות ופרסומים', title: 'שלום כיתה א\'',
      summary: 'מדריך מקיף להורים לקראת המעבר לבית הספר.', link: '' },
    { id: 'nw4', status: 'approved', date: '2026-06-27', section: 'מאמרים', title: '"זה היה בחברות"',
      summary: 'מדריך למחנך להתמודדות עם אלימות ומשחקי נערים בגיל המצווה.', link: '' },
    { id: 'nw5', status: 'approved', date: '2026-05-08', section: 'מאמרים', title: 'ימי מונדיאל: מה בין כדורגל ובין חינוך ולדורף?',
      summary: '', link: '' },
    { id: 'nw6', status: 'approved', date: '2026-04-15', section: 'מודעות ופרסומים', title: 'יום הזיכרון לחללי מערכות ישראל ולנפגעי פעולות איבה',
